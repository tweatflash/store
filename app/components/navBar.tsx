  ...
  return (
    <>
      <nav className="posit bg-neutral-50 flex items-center justify-between p-4 lg:px-6 sticky top-0 z-20 border-gray-200 border-b">
        <div className="block flex-none md:hidden " onClick={() => setIsMobileNav(true)}>
          <button
      ...
      <div
          className={`translate-x-0 fixed flex left-0 right-0 top-[0px] h-full w-full flex-col bg-white pb-6 dark:bg-black z-40 ${isMobileNav ? "translate-x-0" : "translate-x-full"}`}
